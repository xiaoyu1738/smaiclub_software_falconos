...
import base64
import os
import platform  # 导入 platform 模块以识别操作系统
import webbrowser
import json
import hashlib
...
# --- MODIFIED SECTION START: 将配置文件路径指向 AppData ---

def get_config_dir():
    """
    获取用户专属的配置文件夹路径，以避免权限问题。
    ...
    # 使用 os.makedirs 并设置 exist_ok=True，确保文件夹存在且在已存在时不会报错
